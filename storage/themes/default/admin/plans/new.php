                                ...
                                <?php if(isset($feature['custom'])): ?>
                                    <div class="form-group mb-4 d-none">
                                        ...
                                        <?php if($feature['custom']['type'] == 'select'): ?>
                                            <input type="text" class="form-control p-2" name="permission[<?php echo $slug ?>][custom]" id="permission-<?php echo $slug ?>-custom" value="" data-toggle="tags" placeholder="Type here">
                                        <?php endif ?>
