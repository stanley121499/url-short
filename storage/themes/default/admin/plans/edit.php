                                ...
                                <?php if(isset($feature['custom'])): ?>
                                    <div class="form-group mb-4 <?php if(!$plan->permission->{$slug}->enabled || !isset($plan->permission->{$slug}->custom)) echo "d-none" ?>">
                                        ...
                                        <?php if($feature['custom']['type'] == 'select'): ?>
                                            <input type="text" class="form-control p-2" name="permission[<?php echo $slug ?>][custom]" id="permission-<?php echo $slug ?>-custom" value="<?php echo $plan->permission->{$slug}->custom ?? '' ?>" data-toggle="tags">
                                        <?php endif ?>
